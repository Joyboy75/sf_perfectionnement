...
class AdminArticleController extends AbstractController
{
    ...
    public function adminListArticle(ArticleRepository $articleRepository)
    {
    ...
    public function adminCreateArticle(Request $request, EntityManagerInterface $entityManagerInterface)
    {
        $article = new Article();
